...
### 編碼適用於任何資料 {#encoding-for-any-data}
...
### Base64 不是加密法 {#base64-is-not-encryption}
...
### Base64 的變體 base64url {#base64url}
...
### Base64 會增加資料的大小 {#base64-increase-data-size}
...
### Base64 可以去除不可視字元 {#base64-remove-non-printable-characters}
...
## JavaScript 中的 Base64 {#base64-in-javascript}

### [btoa] 跟 [atob] {#btoa-and-atob}
...
## Node.js 的 [Buffer] {#nodejs-buffer}
...
### 轉換任意二進制資料 {#convert-any-binary-data}

除了在 [Encoding](#encoding-api) 中提到的方法，
