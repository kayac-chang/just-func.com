...
# 靜態資源快取管理 Static Assets Caching {#static-asset-caching}
...
## 什麼是靜態資源快取 (Static Assets Caching)？{#what-is-static-assets-caching}
